...
The histogram suggests that there are plots that have been understudied. By comparing distributions of z-scores between a simulated dataset and our dataset, we show that the distribution of sampling for the inventory is not perfectly Poisson and there has been frequency bias throughout the study.    
