...
lide2 <- lide |>
  ...
  rename(LideTotalStem = TotalStem, 
         BCLideTotalStem = BCTotalStem)
...
$$
Redwood living biomass = Fire + Disease + Cwd Biomass
$$

$$
Fire = Disease + Cwd Biomass
$$

$$Disease = CwdBiomass + Bay Laurel Density + LIDE Density$$
...
intro <- "BCTotalBiomass ~ Fire + PRam + BCCWDHostBiomass
          Fire ~ PRam + BCCWDHostBiomass
          PRam ~ BCCWDHostBiomass + BCUmcaTotalStem + BCLideTotalStem
          "
...
semPaths(fit, what = 'est',  fade = FALSE, edge.label.csv = 0.8, sizeMan = 8, nCharNodes = 0, nCharEdges = 0,
residuals = TRUE)
title("Path analysis quantifying CWD fuels as a mediator for disease driven fire impacts to Redwood biomass", line = 3)
```
